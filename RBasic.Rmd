...
<img src='img/Number-of-R-packages-contributed-to-the-Comprehensive-R-Archive-Network-CRAN-as-a.png' style='height: 280px'></img>
<br>
<h3>很容易擴充和客製化</h3>

<img src='img/r-integration-1.png' style='height: 280px'></img>
<br>
<h3>很容易和其他工具做整合</h3>
...
### 環境安裝
- 主程式：[R](https://www.r-project.org/)（R-3.6.0 以上版本）
- 編輯界面：[RStudio IDE](https://www.rstudio.com/products/rstudio/)（1.2.1335 以上版本）
